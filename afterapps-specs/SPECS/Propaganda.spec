...
Source1:	Propaganda-KDE-Desktop
Source2:	ftp://ftp.afterstep.org/stable/rpms/misc-tarballs/Propaganda-Vol13.tar.bz2
Source3:	ftp://ftp.afterstep.org/stable/rpms/misc-tarballs/Propaganda-Vol14.tar.bz2
...
mv README README-KDE

%install
rm -rf $RPM_BUILD_ROOT

mkdir -p $RPM_BUILD_ROOT%{_datadir}%{imagepath}

cp -ar $RPM_BUILD_DIR/%{name}-1/* $RPM_BUILD_ROOT%{_datadir}%{imagepath}

rm -rf $RPM_BUILD_ROOT%{_datadir}%{imagepath}/{README*,COPYING}
